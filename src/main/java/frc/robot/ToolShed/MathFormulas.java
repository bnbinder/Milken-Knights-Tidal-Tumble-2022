...
public class MathFormulas {
     ...
     * the starting and ending point and the distance between the middle of the path
     * and the height of the angular path
     * 
     * <pre>
    .
     ...
     * distance between the starting and ending point and the distance between the
     * middle of the linear path and the max height of the angular path
     * 
     * <pre>
    .
     ...
     * starting and ending point and the distance between the middle of the path and
     * the height of the angular path
     * 
     * <pre>
    .
